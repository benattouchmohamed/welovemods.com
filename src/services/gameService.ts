...
//   imageUrl?: string; 
//   rating: number;
//   size?: string; // Add this (optional if the API might not always return it)
//   version: string;
//   is_mod: boolean;
//   isMod?: boolean;
//   is_premium: boolean;
...
//       isNew: game.is_new,
//       isHot: game.is_hot,
//       features: Array.isArray(game.features) ? game.features : [] // Ensure features is always an array
//     }));
//   } catch (err) {
...
//     // Return with both snake_case and camelCase properties for compatibility
//     return {
//       ...data,
//       imageUrl: data.image_url,
//       isMod: data.is_mod,
