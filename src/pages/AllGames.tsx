...
const AllGames = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[hsl(var(--card))]">
      <Helmet>
        <title>All MOD APK Games – Complete Library | WeLoveMods</title>
        <meta name="description" content="Browse our full library of MOD APK games. 1000+ modded games for Android with unlimited coins, premium unlocks. Free & safe." />
        <link rel="canonical" href="https://welovemods.com/all-games" />
      </Helmet>
      <Navbar />
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="mb-8 flex flex-col sm:flex-row items-center justify-between gap-2">
              <p className="text-[hsl(var(--muted-foreground))] text-sm text-center sm:text-left max-w-xl">
                Browse our complete collection of modded games.
              </p>
              {!isLoading && (
