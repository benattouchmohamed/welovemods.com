  ...
  return (
    <div ref={ref} className="relative z-10">
      ...
      >
        ...
        <ReactCountryFlag countryCode={current.flag} svg className="w-4 h-4 rounded-sm" />
            ...
            {languages.map((lang) => {
              ...
              return (
                <button
                  ...
                  `}
                >
                  <ReactCountryFlag countryCode={lang.flag} svg className="w-5 h-5 rounded" />
