...
export interface TranslationFunctions {
  ...
  error: string;
  supportNote: string;
  tryServer2: string;               // Button text when not opened
  tryServer2Fast: string;           // NEW: Full button text "Try Server 2 (also fast)"
  notCompletedClickAgain: string;   // NEW: Text after clicking offers or Server 2
  tryOffers?: string;
  noOffers?: string;
  confirmExit?: string;
  recommended: string;
...
export const translations: Record<Locale, TranslationFunctions> = {
  en: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "Try Server 2 (also fast)",
  ...
  ar: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "جرب Server 2 (سريع أيضًا)",
  ...
  es: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "Probar Server 2 (también rápido)",
  ...
  fr: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "Essayer Server 2 (aussi rapide)",
  ...
  de: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "Server 2 ausprobieren (auch schnell)",
  ...
  it: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "Prova Server 2 (anche veloce)",
  ...
  pt: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "Experimente Server 2 (também rápido)",
  ...
  tr: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "Server 2'yi Dene (o da hızlı)",
  ...
  ru: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "Попробовать Server 2 (тоже быстро)",
  ...
  zh: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "尝试 Server 2（也很快）",
  ...
  hi: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "Server 2 आज़माएँ (ये भी तेज़ है)",
  ...
  ko: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "Server 2 시도 (역시 빠름)",
  ...
  ja: {
    ...
    tryServer2: "Server 2",
    tryServer2Fast: "Server 2を試す（これも速い）",
