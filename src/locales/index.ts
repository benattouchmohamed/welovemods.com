...
export const translations: Record<Locale, TranslationFunctions> = {
  en: {
    completeOneTask: "Complete 2 tasks to prove you are not a bot",
    gameReady:
      "Once you finish 2 tasks, {game} will start downloading automatically!",
    ...
    autoRedirect: "instant download after tasks",
  ...
  tr: {
    completeOneTask: "Bot olmadığını kanıtlamak için 2 görev tamamla",
    gameReady:
      "2 görevi tamamladığında, {game} otomatik olarak indirilmeye başlayacaktır!",
    ...
    autoRedirect: "görevlerden sonra anında indirme",
  ...
  pt: {
    completeOneTask: "Complete 2 tarefas para provar que não é um robô",
    gameReady: "Assim que terminar 2 tarefas, {game} começará a baixar automaticamente!",
    ...
    autoRedirect: "download instantâneo após tarefas",
  ...
  zh: {
    completeOneTask: "完成 2 个任务以证明你不是机器人",
    gameReady: "完成 2 个任务后，{game} 将自动开始下载！",
  ...
  hi: {
    completeOneTask: "साबित करने के लिए 2 कार्य पूरा करें कि आप बॉट नहीं हैं",
    gameReady: "जैसे ही आप 2 कार्य पूरा करते हैं, {game} स्वतः डाउनलोड होना शुरू हो जाएगा!",
    ...
    autoRedirect: "कार्यों के बाद तुरंत डाउनलोड",
  ...
  it: {
    completeOneTask: "Completa 2 attività per dimostrare che non sei un bot",
    gameReady: "Una volta completate 2 attività, {game} inizierà il download automaticamente!",
    ...
    completeOffer: (n) => `Completa ${n} attività veloci`,
    oneOffer: "2 attività",
  ...
  es: {
    completeOneTask: "Completa 2 tareas para demostrar que no eres un bot",
    gameReady:
      "¡Una vez completes 2 tareas, {game} comenzará a descargarse automáticamente!",
    downloadStarts: "La descarga comenzará automáticamente.",
    offersCompleted: (done, total) => `${done} / ${total} tareas completadas`,
    ...
    autoRedirect: "descarga instantánea tras tareas",
  ...
  ko: {
    completeOneTask: "봇이 아님을 증명하기 위해 2개의 작업을 완료하세요",
    gameReady:
      "2개의 작업을 마치면 {game}이(가) 자동으로 다운로드 시작됩니다!",
  ...
  ja: {
    completeOneTask: "ボットでないことを証明するため 2 つのタスクを完了してください",
    gameReady:
      "2 つのタスクを完了すると、{game} が自動的にダウンロードを開始します！",
  ...
  ar: {
    completeOneTask: "أكمل مهمتين لإثبات أنك لست روبوت",
    gameReady:
      "بمجرد إكمال مهمتين، سيبدأ {game} التحميل تلقائيًا!",
  ...
  fr: {
    completeOneTask: "Terminez 2 tâches pour prouver que vous n’êtes pas un robot",
    gameReady:
      "Dès que vous terminez 2 tâches, {game} démarrera le téléchargement automatiquement !",
    downloadStarts: "Le téléchargement démarre automatiquement.",
    offersCompleted: (done, total) => `${done} / ${total} tâches terminées`,
    howToGuide: "Guide étape par étape",
    completeOffer: (n) => `Terminer ${n} tâches rapides`,
    oneOffer: "2 tâches",
    ...
    autoRedirect: "téléchargement instantané après tâches",
  ...
  ru: {
    completeOneTask: "Выполните 2 задания, чтобы доказать, что вы не бот",
    gameReady:
      "Как только вы завершите 2 задания, {game} начнёт скачиваться автоматически!",
    downloadStarts: "Скачивание начнётся автоматически.",
    offersCompleted: (done, total) => `${done} / ${total} задания выполнено`,
    howToGuide: "Пошаговая инструкция",
    completeOffer: (n) => `Выполнить ${n} быстрых задания`,
    oneOffer: "2 задания",
    ...
    autoRedirect: "мгновенная загрузка после заданий",
  ...
  de: {
    completeOneTask: "Erledige 2 Aufgaben, um zu beweisen, dass du kein Bot bist",
    gameReady:
      "Sobald du 2 Aufgaben erledigst, wird {game} automatisch heruntergeladen!",
    downloadStarts: "Dein Download beginnt automatisch.",
    offersCompleted: (done, total) => `${done} / ${total} Aufgaben erledigt`,
    ...
    autoRedirect: "sofortiger Download nach Aufgaben",
